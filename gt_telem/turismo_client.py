...
class TurismoClient:
    ...
    def _parse_telemetry(self, sr: SpanReader) -> None:
        ...
        self.telemetry = Telemetry(
            ...
            rotation_i=sr.read_single(),
            rotation_j=sr.read_single(),
            rotation_k=sr.read_single(),
            rotation_w=sr.read_single(),
            ...
            brake=sr.read_byte(),
            empty=sr.read_byte(),
            road_plane_i=sr.read_single(),
            road_plane_j=sr.read_single(),
            road_plane_k=sr.read_single(),
            road_plane_w=sr.read_single(),
